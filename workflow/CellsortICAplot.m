function CellsortICAplot(mode, ica_filters, ica_sig, f0, tlims, dt, ratebin, plottype, ICuse, spt, spc,scalelow, scalehigh)
...
%     scalelow - low pixel value to display in averaged image
%     scalehigh - high pixel value to display in averaged image
